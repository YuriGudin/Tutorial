...
/*
* Реализуйте метод шифрования и дешифрования текста с помощью одиночнойперестановки
* по ключу (потом можно довести до двойной перестановки).
*  Немногоиллюстраций по теме есть здесь: ​http://fkn.ktu10.com/?q=node/4399​,
* текста здесь:ru.wikipedia.org/wiki/Симметричные_криптосистемы*/
